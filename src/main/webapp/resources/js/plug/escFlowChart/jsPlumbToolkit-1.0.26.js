        ...
        ElementEntry = function(data, _rotors) {
            ...
            this.compile = function(_rotors, isCustomScope) {
                ...
                if (_rotors.customTags[this.tag]) {
                    ...
                    fb += "_le=_els.pop();_rotors.customTags['" + this.tag + "'].rendered(_le, _rotors);_rotors.pet(_eid,'" + this.uuid +"');";
                    return fb;
                }
            ...
            this.update = function(el, data) {
                ...
                if (this.originalCustomTag) {
                    _rotors.customTags[this.originalCustomTag].updated(el, data);
                }
            };
        },
...
(function () {
    ...
    exports.Selection = function (params) {
        ...
        /**
         * Gets all Edges for the given Node.
        ...
        var _prepareConnectionParams = function (edge) {
            ...
            var _one = function (name) {
                if (edge[name].getNode) {
                    ...
                    p[name] = nodeMap[_toolkit.getNodeId(edge[name].data)];
            };
                    ...
                    if (nodeMap[n.id]) {
                        ...
                        for (var j = 0; j < edges.length; j++) {
                            if (edges[j].source == n || edges[j].source.getNode && edges[j].source.getNode() == n) {
                                var def = view.getEdgeDefinition(_toolkit.getNodeType(edges[j].data));
            ...
            panzoom = new ZoomWidget({
                ...
                events: {
                    ...
                    mousedown: function () {
                        ...
                        jsPlumb.addClass(document.body, _cl.SELECT_DEFEAT);
                    },
                    mouseup: function () {
                        jsPlumb.removeClass(containerElement, _cl.SURFACE_PANNING);
                        jsPlumb.removeClass(document.body, _cl.SELECT_DEFEAT);
                    }
                }
            }),
            lassoSelections = [],
